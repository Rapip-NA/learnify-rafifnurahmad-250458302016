...
<head>
    ...
    <title>403 - Akses Ditolak | Learnify</title>
    ...
    <style>
        ...
        * {
        ...
        .text-gradient-403 {
            background: linear-gradient(135deg, #dc2626 0%, #db2777 50%, #f59e0b 100%);
...
<body class="bg-gradient-to-br from-slate-50 via-white to-red-50 overflow-x-hidden">
    <!-- Light mode animated background blobs -->
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div class="blob w-96 h-96 rounded-full gradient-accent" style="top: -100px; left: -100px;"></div>
        <div class="blob w-96 h-96 rounded-full bg-amber-400" style="top: 50%; right: -100px; animation-delay: 2s;"></div>
        <div class="blob w-80 h-80 rounded-full bg-red-400" style="bottom: 0; left: 50%; animation-delay: 4s;"></div>
    </div>
    ...
    <section class="min-h-screen flex items-center justify-center pt-20 pb-20 px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-4xl w-full">
            ...
            <div class="text-center space-y-8 slide-in">
                <!-- 403 Error Code Display with gradient and animation -->
                <div class="relative inline-block w-full">
                    <h1 class="text-9xl md:text-[200px] font-black text-gradient-403 leading-none drop-shadow-lg">
                        403
                    </h1>
                    <div class="absolute inset-0 blur-3xl opacity-30 gradient-accent rounded-full"
                        style="top: -50px; left: 50%; transform: translateX(-50%);"></div>
                </div>

                <!-- Floating emojis around 403 -->
                <div class="relative h-20 mx-auto">
                    ...
                    <div class="floating-element element-4 text-5xl" style="right: 5%; top: 10px;">🛡️</div>
                </div>
                ...
                <div class="space-y-4 slide-in" style="animation-delay: 0.1s;">
                    ...
                    <p class="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                        Maaf! Anda tidak memiliki izin untuk mengakses halaman ini. Silakan hubungi administrator jika
                ...
                <div class="relative h-64 md:h-80 mx-auto max-w-lg slide-in" style="animation-delay: 0.2s;">
                    <div class="absolute inset-0 gradient-accent opacity-10 rounded-3xl blur-2xl"></div>
                    <div
                        class="relative bg-gradient-to-br from-red-100 to-amber-100 rounded-3xl h-full flex flex-col items-center justify-center overflow-hidden border-2 border-red-200">
                        <div class="text-center space-y-4">
                            <div class="text-8xl bounce-big">🔐</div>
                            <div class="space-y-2">
                                <p class="text-slate-700 font-bold">Area Terbatas!</p>
                                <p class="text-slate-600 text-sm">Anda memerlukan izin khusus untuk mengakses halaman
                                    ini</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center slide-in" style="animation-delay: 0.3s;">
                    ...
                    <a href="#"
                        class="border-2 border-red-600 text-red-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-red-600 hover:text-white transition backdrop-blur-sm inline-block">
                        💬 Hubungi Admin
                    </a>
                </div>
                ...
                <div class="pt-12 slide-in" style="animation-delay: 0.5s;">
                    <div
                        ...
                        <div class="bg-slate-50 rounded-lg p-4 font-mono text-sm text-slate-900 overflow-x-auto">
                            <span class="text-red-600">Error:</span> HTTP <span class="text-yellow-600">403</span> -
                            <span class="text-slate-700">Forbidden</span><br>
