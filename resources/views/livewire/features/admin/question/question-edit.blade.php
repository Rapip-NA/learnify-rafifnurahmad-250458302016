    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-8 order-md-1 order-last">
                <h3>Edit Question</h3>
                <p class="text-subtitle text-muted">Update the details and answers for this question.</p>
            </div>
            ...
            <div class="col-12 col-lg-10">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update Question Details</h4>
                    </div>
                            ...
                            <form wire:submit.prevent="update">
                                ...
                                <div class="mb-5 p-4 border rounded bg-light">
                                    ...
                                    <p class="text-sm text-muted mt-3">
                                        <strong>Tip:</strong> Use the radio button next to the field to mark the correct
                                        answer.
                                    </p>
                                </div>
