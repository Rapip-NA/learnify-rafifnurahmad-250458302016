    ...
    <div>
            ...
            <div>
                ...
                <div class="mb-8">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            <h1
                                class="text-3xl font-bold text-transparent bg-gradient-to-r from-indigo-400 to-pink-400 bg-clip-text flex items-center gap-2 mb-2">
                        ...
                        <div class="flex items-center gap-3">
                            <a href="{{ route('admin.badges.index') }}" wire:navigate
                                class="inline-flex justify-center items-center gap-2 px-4 py-2 bg-slate-800 border border-slate-700 text-white rounded-xl hover:bg-slate-700 transition w-full md:w-auto">
                                ...
                                <form wire:submit="save" class="space-y-6">
                                    ...
                                    @if ($condition_type === 'completion_count')
                                        <div class="ml-4 bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                                            <label class="block text-sm font-semibold text-green-400 mb-2">
                                                <i class="bi bi-check2-all"></i> Jumlah Kompetisi yang Harus
                                                Diselesaikan
                                            </label>
                                            <input type="number" wire:model.live="required_count" min="1"
                                                value="1"
                                    ...
                                    @if ($condition_type === 'first_completion')
                                        <div
                                            ...
                                            <p class="text-sm text-blue-400">Badge ini akan diberikan otomatis saat
                                                peserta
                                    ...
                                    <!-- Icon -->
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-300 mb-2">Icon
                                            (Emoji)</label>
                                    ...
                                    <!-- Image URL -->
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-300 mb-2">URL
                                            Gambar</label>
                                        ...
                                        @error('image_url')
                                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                                        @enderror
                                        <p class="mt-2 text-xs text-slate-400">Opsional. URL gambar badge jika
                                            tersedia.
                                        </p>
                                    </div>
                                    ...
                                    <!-- Buttons -->
                                    <div
                                        class="flex flex-col md:flex-row justify-end gap-4 pt-6 border-t border-slate-700">
                                        <a href="{{ route('admin.badges.index') }}" wire:navigate
                                            class="inline-flex justify-center items-center px-6 py-3 bg-slate-700 text-white font-semibold rounded-xl hover:bg-slate-600 transition w-full md:w-auto">
                                            <i class="bi bi-x-circle mr-2"></i>
                                            Batal
                                        </a>
                                        <button type="submit"
                                            class="inline-flex justify-center items-center gap-2 px-6 py-3 gradient-primary text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-indigo-500/50 transition w-full md:w-auto">
        ...
        <style>
            ...
            body.light-theme .sticky {
                background: white !important;
                /* Ensure sticky header in light mode doesn't look weird if transparent */
            }
        </style>
    </div>
