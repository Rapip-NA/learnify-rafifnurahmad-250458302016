    ...
    <div>
        <div>
            ...
            <div
                            ...
                            <div class="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-400">{{ $category->created_at->format('H:i A') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-400">{{ $category->updated_at->format('H:i A') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-500/10 border border-slate-500/30 rounded-xl p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-white">{{ $category->created_at->diffForHumans() }}
                                        </p>
                ...
                <!-- Footer -->
                <div class="p-4 md:p-6 border-t border-slate-700 flex flex-col md:flex-row justify-between gap-4">
                    <a href="{{ route('admin.categories.index') }}"
                        class="inline-flex justify-center items-center gap-2 px-6 py-3 bg-slate-700 text-white font-semibold rounded-xl hover:bg-slate-600 transition-all w-full md:w-auto">
