        ...
        <div>
            ...
            <div class="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-6">
                <form wire:submit.prevent="save" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-slate-300 mb-2">
                            Competition Duration <span class="text-red-400">*</span>
                        </label>
                        <p class="text-slate-400 text-sm mb-4 flex items-center gap-2">
                            <i class="bi bi-info-circle"></i>
                            Set how long participants have to complete the competition
                        </p>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Hours -->
                            <div>
                                <label class="block text-sm font-medium text-slate-400 mb-2">Hours</label>
                                <input type="number" wire:model="duration_hours" min="0" max="23"
                                    class="w-full px-4 py-3 bg-slate-900 border @error('duration_hours') border-red-500 @else border-slate-700 @enderror rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                                    placeholder="0">
                            ...
                            <!-- Minutes -->
                            <div>
                                <label class="block text-sm font-medium text-slate-400 mb-2">Minutes</label>
                                <input type="number" wire:model="duration_minutes" min="0" max="59"
                                    class="w-full px-4 py-3 bg-slate-900 border @error('duration_minutes') border-red-500 @else border-slate-700 @enderror rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                                    placeholder="30">
                            ...
                            <div class="mt-4 p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl">
                                <p class="text-blue-400 text-sm flex items-center gap-2">
                                    ...
                                    <strong>
                                        ...
                                        @endif
                                        ({{ (int) $duration_hours * 60 + (int) $duration_minutes }} minutes total)
                                    </strong>
                                </p>
                            </div>
                        @endif
