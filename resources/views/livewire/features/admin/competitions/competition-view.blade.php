    ...
    <div>
        <div>
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-4">
                            ...
                            <p class="text-white text-lg font-semibold">{{ $competition->start_date->format('F d, Y') }}
                            </p>
                        ...
                        <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-4">
                            ...
                            <p class="text-white text-lg font-semibold">{{ $competition->end_date->format('F d, Y') }}
                            </p>
                        ...
                        <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-4">
                            ...
                            <p class="text-white text-lg font-semibold">{{ $competition->creator->name ?? 'Unknown' }}
                            </p>
                ...
                <!-- Card Footer -->
                <div class="p-6 border-t border-slate-700 flex flex-col sm:flex-row justify-end">
                    <a href="{{ route('admin.competitions.edit', $competition) }}"
                        class="inline-flex items-center justify-center gap-2 px-6 py-3 gradient-primary text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-indigo-500/50 transition-all w-full sm:w-auto">
